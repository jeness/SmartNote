...
module.exports = {
    async signUp (ctx) {
        ...
        if (!username && !password) {
            ...
            result.message = 'Please fill in username and password!';            
            ctx.body = result;
        } else {
            ...
            if(!user) {
                ...
                if (!doc.errors) {
                    ...
                    ctx.body = {success: true, message: 'Registration Success'}
                ...
                ctx.body = { success: false, message: 'The user is existed!'};                
            }
        }
    },
        ...
        await User.findOne({
            ...
            if (!user) {
                ...
                if (password === user.password) {
                    ...
                    ctx.body = {success: true, message: 'Signin Success'}                    
                } else {
