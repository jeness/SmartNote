                ...
                <Form onSubmit={this.handleSubmit}>
                    <FormItem>
                        {getFieldDecorator('username', {
                            ...
                            <Input addonBefore={<Icon type="user" />} placeholder="Please enter your username!" />
                        )}
                    </FormItem>
                    <FormItem>
                        {getFieldDecorator('password', {
                            ...
                            <Input addonBefore={<Icon type="lock" />} type="password" placeholder="Please enter your password!" />
